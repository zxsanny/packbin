# Python pack and unpack

**Task**: AZ-1878_python_pack
**Name**: Python pack and unpack
**Description**: Python pack and unpack of a caller-owned field list, matching the golden hex.
**Complexity**: 5 points
...
tools and scripts needs the same bytes as the other five languages. A tagged serializer would change the size.
...
- The package is what PyPI `packbin` publishes
...
- The package identity PyPI `packbin`, license MIT
...
- **Capability**: pack and unpack in Python
