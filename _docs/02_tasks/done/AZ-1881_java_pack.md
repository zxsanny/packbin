# Java pack and unpack

**Task**: AZ-1881_java_pack
**Name**: Java pack and unpack
**Description**: Java pack and unpack of a caller-owned field list, matching the golden hex.
**Complexity**: 5 points
...
Android and other Java programs needs the same bytes as the other five languages. A tagged serializer would change the size.
...
- The package is what Maven Central `packbin` publishes
...
- The package identity Maven Central `packbin`, license MIT
...
- **Capability**: pack and unpack in Java
