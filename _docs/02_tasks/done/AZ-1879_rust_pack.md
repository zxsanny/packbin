# Rust pack and unpack

**Task**: AZ-1879_rust_pack
**Name**: Rust pack and unpack
**Description**: Rust pack and unpack of a caller-owned field list, matching the golden hex.
**Complexity**: 5 points
...
a native node needs the same bytes as the other five languages. A tagged serializer would change the size.
...
- The package is what crates.io `packbin` publishes
...
- The package identity crates.io `packbin`, license MIT
...
- **Capability**: pack and unpack in Rust
