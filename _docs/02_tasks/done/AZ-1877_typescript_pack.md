# TypeScript pack and unpack

**Task**: AZ-1877_typescript_pack
**Name**: TypeScript pack and unpack
**Description**: TypeScript pack and unpack of a caller-owned field list, matching the golden hex.
**Complexity**: 5 points
...
Vue, React, and Node needs the same bytes as the other five languages. A tagged serializer would change the size.
...
- The package is what npm `packbin` publishes
...
- The package identity npm `packbin`, license MIT
...
- **Capability**: pack and unpack in TypeScript
